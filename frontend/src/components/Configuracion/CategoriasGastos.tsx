...
const CategoriasGastos: React.FC = () => {
  ...
  const cargarCategorias = async () => {
    try {
      const response = await axios.get(`${API_URL}/categorias-gastos`);
  ...
  const cargarSubcategorias = async () => {
    try {
      const response = await axios.get(`${API_URL}/subcategorias-gastos`);
  ...
  const guardarCategoria = async () => {
    ...
    try {
      ...
      if (categoriaEditando) {
        ...
        response = await axios.put(`${API_URL}/categorias-gastos/${categoriaEditando.id}`, {
        ...
        response = await axios.post(`${API_URL}/categorias-gastos`, {
          nombre: nombreCategoria,
          activo: activoCategoria
        });
  ...
  const confirmarEliminarCategoriaHandler = async () => {
    if (categoriaAEliminar !== null) {
      try {
        await axios.delete(`${API_URL}/categorias-gastos/${categoriaAEliminar}`);
  ...
  const guardarSubcategoria = async () => {
    ...
    try {
      ...
      if (subcategoriaEditando) {
        ...
        response = await axios.put(`${API_URL}/subcategorias-gastos/${subcategoriaEditando.id}`, {
        ...
        response = await axios.post(`${API_URL}/subcategorias-gastos`, {
          nombre: nombreSubcategoria,
          categoriaId: categoriaSeleccionada,
          activo: activoSubcategoria
        });
  ...
  const confirmarEliminarSubcategoriaHandler = async () => {
    if (subcategoriaAEliminar !== null) {
      try {
        await axios.delete(`${API_URL}/subcategorias-gastos/${subcategoriaAEliminar}`);
