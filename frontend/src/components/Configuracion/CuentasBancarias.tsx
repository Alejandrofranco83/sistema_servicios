...
const cuentaBancariaService = {
  ...
  createCuentaBancaria: async (cuenta: Omit<CuentaBancaria, 'id'>): Promise<CuentaBancaria> => {
    try {
      ...
      console.log('URL:', `${API_BASE_URL}/cuentas-bancarias`);
      
      const response = await axios.post(`${API_BASE_URL}/cuentas-bancarias`, cuenta);
  ...
  updateCuentaBancaria: async (id: number, cuenta: Partial<CuentaBancaria>): Promise<CuentaBancaria> => {
    try {
      ...
      console.log('URL:', `${API_BASE_URL}/cuentas-bancarias/${id}`);
      
      const response = await axios.put(`${API_BASE_URL}/cuentas-bancarias/${id}`, cuenta);
  ...
  deleteCuentaBancaria: async (id: number): Promise<void> => {
    try {
      ...
      await axios.delete(`${API_BASE_URL}/cuentas-bancarias/${id}`);
